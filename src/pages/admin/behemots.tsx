...
const Guides = () => {
  ...
  return (
    <>
      ...
      <SectionMain>
        <SectionTitleLineWithButton icon={mdiBookOpenVariant} title="Behemots" />
        <CardBox hasTable={true}>
          ...
          <div className="flex h-10">
            ...
            <div className="h-full text-emerald-500 hover:text-emerald-400 m-1.5 mr-3">
              <Link href="behemots/new" className={'h-32'}>
          ...
          <table>
            ...
            <tbody>
              {filteredGuides.map((guide: Guide) => (
                <tr key={guide.id}>
                  <td data-label="Name">
                    <Link href={`behemots/${guide.id}`} className={'h-32'}>
                  ...
                  <td data-label="Visible" className="text-sm text-stone-200 text-center">
                    {guide.visible ? (
                      <BaseIcon path={mdiCheck} customBoxSize={22} size={24} />
                    ) : (
                      <BaseIcon path={mdiClose} customBoxSize={22} size={24} />
                    )}
                  </td>
