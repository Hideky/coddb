...
export const gradientBgDark = `${gradientBgBase} from-stone-700 to-stone-900`
export const gradientBgPinkRed = `${gradientBgBase} from-pink-400 via-red-500 to-yellow-500`
export const gradiantBgArmory = `${gradientBgBase} from-stone-700 to-stone-900`
// export const gradiantBgArmory = `${gradientBgBase} #211510 #201306 #040b17`

export const colorsBgLight = {
  white: 'bg-white text-black',
  light: 'bg-stone-900/70 text-white',
...
export const colorsTextQuality = {
...
export const colorsOutline = {
  ...
  contrast: [colorsText.contrast, 'border-stone-100'].join(' '),
...
export const getButtonColor = (
  ...
  const colors = {
    ...
    active: {
      white: 'bg-gray-100',
      whiteDark: 'bg-stone-800',
      lightDark: 'bg-stone-700',
    ...
    bg: {
      white: 'bg-white text-black',
      whiteDark: 'bg-stone-900 text-white',
      lightDark: 'bg-stone-800 text-white',
      contrast: 'bg-white text-black',
    ...
    bgHover: {
      ...
      whiteDark: 'hover:bg-stone-800',
      lightDark: 'hover:bg-stone-700',
      contrast: 'hover:bg-stone-100',
      success:
    ...
    borders: {
      white: 'border-white',
      whiteDark: 'border-stone-900',
      lightDark: 'border-stone-800',
    ...
    outlineHover: {
      ...
      success:
        'hover:text-white hover:border-emerald-600',
      danger:
        'hover:text-white hover:border-red-600',
      warning:
        'hover:text-white hover:border-yellow-600',
